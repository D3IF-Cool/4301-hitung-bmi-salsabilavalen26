...
import org.d3if2092.hitungbmi.data.HasilBmi
import org.d3if2092.hitungbmi.data.KategoriBmi
import org.d3if2092.hitungbmi.db.BmiDao
import org.d3if2092.hitungbmi.db.BmiEntity
...
class HitungViewModel(private val db: BmiDao) : ViewModel() {
    ...
    //Variabel ini sudah berupa LivaData (tidak mutable),
